        ...
        if let homeViewModel {
            ...
            .sheet(isPresented: $showSettings) {
                if let memoryViewModel, let databaseManager = appState.databaseManager {
                    SettingsView(memoryViewModel: memoryViewModel, databaseManager: databaseManager, appState: appState, notificationService: checkInNotificationService, notificationScheduler: notificationScheduler)
                }
            }

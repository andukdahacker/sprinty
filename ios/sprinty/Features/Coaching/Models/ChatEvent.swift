...
enum ChatEvent: Sendable {
    ...
    case done(safetyLevel: String, domainTags: [String], mood: String?, mode: String?, challengerUsed: Bool?, usage: ChatUsage, promptVersion: String?, profileUpdate: ProfileUpdate?)
}
